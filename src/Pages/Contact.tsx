        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    At <span className="text-blue-600">Keyboard Commerce</span>, we take pride in our global presence, strategically located to serve our customers efficiently. Each office is designed to foster creativity, collaboration, and excellence, ensuring that we deliver the best products and services to our customers.
                    </p>
                </div>
